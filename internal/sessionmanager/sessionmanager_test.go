...
func (fs *fakeSession) ReceiveFrom(from peer.ID, ks []cid.Cid, haves []cid.Cid, dontHaves []cid.Cid, largeBlockManifests []bsmsg.LargeBlockManifest) {
	fs.ks = append(fs.ks, ks...)
	fs.wantBlocks = append(fs.wantBlocks, haves...)
	fs.wantHaves = append(fs.wantHaves, dontHaves...)
}
...
func TestReceiveFrom(t *testing.T) {
	...
	sm.ReceiveFrom(ctx, p, []cid.Cid{block.Cid()}, []cid.Cid{}, []cid.Cid{}, nil)
	...
	sm.ReceiveFrom(ctx, p, []cid.Cid{}, []cid.Cid{block.Cid()}, []cid.Cid{}, nil)
	...
	sm.ReceiveFrom(ctx, p, []cid.Cid{}, []cid.Cid{}, []cid.Cid{block.Cid()}, nil)
...
func TestShutdown(t *testing.T) {
	...
	sm.ReceiveFrom(ctx, p, []cid.Cid{}, []cid.Cid{}, cids, nil)
